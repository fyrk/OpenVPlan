...
window.addEventListener("error",a=>e(a.error,a));window.addEventListener("unhandledrejection",a=>e(a.reason));const h=window.location.pathname.split("/",2)[1],k=document.getElementById("selectionInput").value;
