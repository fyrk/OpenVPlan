...
window.addEventListener("online",()=>{console.log("online, checking for new substitutions");P()});window.addEventListener("offline",()=>{console.log("offline");N()});document.getElementById("themes-block").appendChild(document.getElementById("themes-block-template").content);const Q=document.documentElement,R=document.getElementById("themes-system-default"),S=document.getElementById("themes-light"),T=document.getElementById("themes-dark");function U(a){"system-default"===a&&(a="system-"+(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"));m("theme",a)}
