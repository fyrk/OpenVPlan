...
break;default:G=c}H(G,a)}),plausible("Push Subscription: Subscribe")):("granted-and-enabled"===G&&H("granted-and-disabled",a),plausible("Push Subscription: Unsubscribe"))});window.addEventListener("focus",b);G=window.localStorage.getItem(g+"-notification-state");if(null==G||"failed"===G)G="default";b()||H(G,a)}
