...
function D(a){function b(){return B.startsWith(Notification.permission)?!1:("granted"===Notification.permission?C("granted-and-disabled",a):C(Notification.permission,a),!0)}document.getElementById("notifications-block").hidden=!1;r.addEventListener("change",()=>{r.checked?window.Notification.requestPermission().then(c=>{switch(c){case "granted":B="granted-and-enabled";break;default:B=c}C(B,a)}):"granted-and-enabled"===B&&C("granted-and-disabled",a)});window.addEventListener("focus",b);B=window.localStorage.getItem(h+
